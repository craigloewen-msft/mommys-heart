...
const USERS: [SeedUser; 8] = [
    ...
    SeedUser {
        ...
        role: Volunteer,
        assignments: &[(2, Manager), (1, Contributor), (4, Contributor), (6, Contributor)],
    },
    SeedUser {
        first: "James",
        last: "Garcia",
        ...
        password: "volunteer123",
        role: Volunteer,
        assignments: &[(3, Contributor), (5, Contributor), (7, Contributor), (2, Viewer)],
    },
    SeedUser {
        first: "Aisha",
        last: "Okafor",
    ...
    USERS
        ...
        .map(|(i, su)| {
            let user = User {
                ...
                email: su.email.into(),
                phone: format!("(555) {:03}-{:04}", (i * 13 + 7) % 1000, (i * 97 + 11) % 10000),
...
const CASES: [SeedCase; 8] = [
    SeedCase {
        ...
        owner: 5,
        docket: "FC-2026-0001",
        notes: &[("Dana Patel", "Client prefers phone contact in the evenings.", "2026-02-04 09:00")],
        evidence: &[(
            "Court summons",
            "Jamie Rivera",
            "2026-02-03 14:30",
    ...
    SeedCase {
        ...
        owner: 6,
        docket: "FC-2026-0003",
        notes: &[("Maria Nguyen", "Case closed favorably; retain records for three years.", "2026-02-20 10:00")],
        evidence: &[(
    ...
    SeedCase {
        ...
        owner: 5,
        docket: "FC-2026-0006",
        notes: &[("Aisha Okafor", "Safety plan reviewed with the client.", "2026-05-04 09:30")],
        evidence: &[],
    },
    SeedCase {
...
const MESSAGES: &[(u32, &str, &str, &str)] = &[
    ...
    (1, "Dana Patel", "Hi Jamie, I've opened your custody case and I'll be your main contact.", "2026-02-03 09:15"),
    (1, "Jamie Rivera", "Thank you, Dana. I uploaded the court summons this morning.", "2026-02-03 14:40"),
    (1, "Dana Patel", "Got it — I see the summons. I'll draft our response this week.", "2026-02-05 10:05"),
    (1, "Maria Nguyen", "Reviewed the file. Let's keep this Open for now.", "2026-02-09 16:20"),
    // c-2 Rivera housing assistance
    (2, "Dana Patel", "Moving this housing matter to Monitor while we wait on the landlord.", "2026-03-01 11:00"),
    (2, "Dana Patel", "Updated the docket after the clerk reassigned it.", "2026-03-06 13:30"),
    // c-3 Silva benefits appeal
    (3, "James Garcia", "Sofia, your benefits appeal packet is complete and filed.", "2026-01-12 08:45"),
    (3, "Sofia Silva", "Wonderful, thank you James!", "2026-01-12 15:10"),
    (3, "Maria Nguyen", "Appeal granted — closing this case. Great work, everyone.", "2026-02-20 09:30"),
    // c-4 Kim guardianship petition
    (4, "Dana Patel", "Noah, the guardianship petition is ready for your signature.", "2026-04-02 10:20"),
    (4, "Noah Kim", "Signed and scanned back to you.", "2026-04-03 12:00"),
    // c-5 Johnson support modification
    (5, "James Garcia", "Emma, I've requested the updated income records for the modification.", "2026-03-18 09:00"),
    (5, "Emma Johnson", "I'll send my latest pay stubs today.", "2026-03-18 17:45"),
    // c-6 Rivera protective order
    (6, "Aisha Okafor", "Protective order paperwork is drafted and ready to file.", "2026-05-04 10:15"),
    (6, "Jamie Rivera", "Please file it as soon as possible.", "2026-05-04 10:40"),
    (6, "Dana Patel", "Filed with the court this afternoon.", "2026-05-04 15:20"),
    // c-7 Silva housing assistance
    (7, "James Garcia", "Sofia, the housing authority confirmed your application is under review.", "2026-05-11 11:30"),
    (7, "Sofia Silva", "Thanks for the update.", "2026-05-12 09:05"),
    // c-8 Kim custody matter
    (8, "Aisha Okafor", "Noah, I've scheduled the custody mediation for next month.", "2026-06-01 14:00"),
