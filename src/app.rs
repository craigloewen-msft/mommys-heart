...
use crate::pages::{
    admin::AdminDashboardPage, chat::ChatPage, contact_detail::ContactDetailPage,
    contacts::ContactsPage, dashboard::DashboardPage, login::LoginPage, register::RegisterPage,
